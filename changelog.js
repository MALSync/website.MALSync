...
function changelog() {
  ...
  changelogData.forEach(function (version) {
    html += `<div class="text-box" id="${version.title.replace(/\./g, "-")}">
		...
		<a target="_blank" rel="noopener" href="https://github.com/MALSync/MALSync/releases/tag/${
      version.title
    }">
  ...
  function messageHandling(message) {
    // Patch: Normalize GitHub user anchor tags' text to always match the username
    message = message.replace(
      // Match only github.com user anchors, avoid organizations by convention
      /<a\s+[^>]*href="https:\/\/github\.com\/([A-Za-z0-9-_]+)"[^>]*>(.*?)<\/a>/g,
      (match, username, text) => {
        // Only override if the text does not already match (case sensitive)
        if (text !== username) {
          return match.replace(`>${text}<`, `>${username}<`);
        }
        return match;
      }
    );
    ...
    if (issues) {
      issues.forEach(function (issue) {
        message = message.replace(
          issue,
          '<a target="_blank" rel="noopener" href="https://github.com/MALSync/MALSync/issues/' +
            issue.replace("#", "") +
            '">' +
            issue +
            "</a>"
...
var changelogData = [
  {
    ...
    data: [
      ...
      "[FEATURE] Support activity name customization in Discord Rich Presence",
      '[BUGFIX] Fix duplicate entries in quicklinks <a href="https://github.com/Source-Dom" target="_blank" rel="noopener">Source-Do</a>',
      '[FEATURE] Add Animeav1 <a href="https://github.com/dolvem" target="_blank" rel="noopener">dolve</a>',
      '[FEATURE] Add Anicrush <a href="https://github.com/PrayagS" target="_blank" rel="noopener">Prayag</a>',
      '[FEATURE] Add Animevost <a href="https://github.com/andrzej-zuralovic" target="_blank" rel="noopener">andrzej-zuralovi</a>',
      '[FEATURE] Add MangaDemon <a href="https://github.com/SoldierZoom" target="_blank" rel="noopener">SoldierZoo</a>',
      '[FEATURE] Add RoliaScan <a href="https://github.com/SoldierZoom" target="_blank" rel="noopener">SoldierZoo</a>',
      '[FEATURE] Add Mangitto <a href="https://github.com/roxyrekt" target="_blank" rel="noopener">roxyrek</a>',
      '[FEATURE] Add Anizium <a href="https://github.com/Fen1kks" target="_blank" rel="noopener">Fen1kk</a>',
      '[FEATURE] Add QiScans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add StoneScape <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Thunderscans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Utoon <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Reset scans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add WitchScans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Arven comics <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Aurora scans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      "[FEATURE] Add Anixl",
      '[FEATURE] Add Comikey <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Madarascans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Sadscans <a href="https://github.com/Fen1kks " target="_blank" rel="noopener">Fen1kks</a>',
      '[FEATURE] Add Atsu <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add ComicTop <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add MangaTaro <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Genz Toon <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Asmodeus Scans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Drake Scans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add jestful <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Galaxy degen scans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Philia Scans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      "[FEATURE] Add Novelfire ",
      '[FEATURE] Add Armageddon <a href="https://github.com/tigeryu8900 " target="_blank" rel="noopener">tigeryu8900</a>',
      '[FEATURE] Add Mangapill <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add TCBScans <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add Mangaball <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      "[FEATURE] Add Animekhor",
      '[FEATURE] Add Kagane <a href="https://github.com/gickass " target="_blank" rel="noopener">gickass</a>',
      '[FEATURE] Add VioletScans <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
      '[FEATURE] Add WritersScans <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
      '[FEATURE] Add RokariScans <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
      "[FEATURE] Add KakuseiProject",
      '[FEATURE] Add Danke fürs Lesen <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
      '[FEATURE] Add KappaBeast <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
      '[FEATURE] Add French-anime <a href="https://github.com/FurTorie" target="_blank" rel="noopener">FurTori</a>',
      '[FEATURE] Add AnimeHeaven <a href="https://github.com/CaptPlasma" target="_blank" rel="noopener">CaptPlasm</a>',
      '[FEATURE] Add Ritharscans <a href="https://github.com/tigeryu8900" target="_blank" rel="noopener">tigeryu890</a>',
      '[FEATURE] Add SakuraMangas <a href="https://github.com/Jhoorodre" target="_blank" rel="noopener">Jhoorodr</a>',
      '[FEATURE] Add Falcon Scans <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
      '[FEATURE] Add Comic Days <a href="https://github.com/gickass" target="_blank" rel="noopener">gickas</a>',
    ],
  },
  {
    title: "0.12.0",
  ...
  {
    title: "0.9.5",
    data: ["[Bugfix] Hotfix 9anime", "[Bugfix] Hotfix Animesuge"],
  },
  {
    title: "0.9.4",
    data: [
  ...
  {
    title: "0.8.3",
    data: ["[BUGFIX] Hotfix episode progeress missing"],
  },
  {
    title: "0.8.2",
    data: [
  ...
  {
    title: "0.7.8",
    data: ["[BUGFIX] hotfix MyAnimeList and Anilist onsite lists"],
  },
  {
    title: "0.7.7",
    data: ["[BUGFIX] Firefox hotfix"],
  },
  {
    title: "0.7.6",
    data: [
  ...
  {
    title: "0.4.11",
    data: ["[BUGFIX] HOTFIX: Remove debugging alert"],
  },
  {
    title: "0.4.10",
    data: [
  ...
  {
    title: "0.2.11",
    data: ["[FEATURE] Check for new episodes and notify the user"],
  },
  {
    title: "0.2.10",
    data: [
  ...
  {
    title: "0.2.9",
    data: ["[BUGFIX] Episode sync not working"],
  },
  {
    title: "0.2.8",
    data: [
  ...
  {
    title: "0.2.3",
    data: ["[BUGFIX] Handle alternative MAL url", "[TASK] Update badges"],
  },
  {
    title: "0.2.2",
    data: [
  ...
  {
    title: "0.2.1",
    data: ["[BUGFIX] Firefox not loading"],
  },
  {
    title: "0.2.0",
    data: [
